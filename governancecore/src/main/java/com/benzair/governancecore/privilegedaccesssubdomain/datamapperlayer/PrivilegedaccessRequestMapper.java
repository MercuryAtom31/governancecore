...
public interface PrivilegedAccessRequestMapper {
    ...
    @Mapping(target = "requesterFirstName", ignore = true)
    @Mapping(target = "requesterLastName", ignore = true)
    ...
    @Mapping(target = "grantedByFirstName", ignore = true)
    @Mapping(target = "grantedByLastName", ignore = true)
